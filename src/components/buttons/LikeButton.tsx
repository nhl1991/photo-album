    ...
    return (
        <div className="flex w-max h-max items-center justify-center">
            <button onClick={onClick} className="cursor-pointer">
                <svg className="w-4 md:w-6" data-slot="icon" fill={userLike ? "red" : "none"} strokeWidth={1.5} stroke={userLike ? "red" : "white"} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
