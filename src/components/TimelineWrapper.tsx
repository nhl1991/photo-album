export default function TimelineWrapper({
  ...
  return (
      ...
      <div className="max-w-[1920px]   w-screen min-h-[720px] grid grid-cols-[repeat(2,minmax(160px,1fr))] grid-rows-[repeaet(4,minmax(160px,160px))] md:grid-cols-[repeat(4,minmax(320px,640px))] auto-rows-[min(160px)] md:grid-rows-[repeat(2,minmax(320px,480px))]  md:auto-rows-[minmax(320px,480px)] gap-0.5 md:gap-2 p-4">
        {children}
      </div>
