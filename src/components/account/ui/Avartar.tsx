        ...
        <div>
            <label htmlFor="avartar" className="hover:cursor-pointer">
                <div className="w-36 h-36 bg-gray-500 relative rounded-full overflow-hidden">
                    {user && user.photoURL ? <Image src={user.photoURL} className="object-cover" fill alt="image" sizes="(max-width: 768px) 100vw, 33vw" priority /> : <svg className="w-full" data-slot="icon" fill="none" strokeWidth={1.5} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
